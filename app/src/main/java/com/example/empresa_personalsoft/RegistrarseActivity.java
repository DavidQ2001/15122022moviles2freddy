...
public class RegistrarseActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public void Consultar(View view){
         ...
         if (usuario.isEmpty()){
            ...
            url = "http://172.16.61.0/webservices/consulta.php?usr=" + usuario;
    ...
    public void Adicionar_usuario(View view){
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()){
            ...
            jetusuario.requestFocus();
                ...
                url = "http://172.16.61.0/webservices/registrocorreo.php";
    ...
    public void Modificar_usuario(View view){
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()){
            ...
            url = "http://172.16.61.0/webservices/actualiza.php";
    ...
    public void Anular_usuario(View view){
        usuario=jetusuario.getText().toString();
        ...
        if (usuario.isEmpty()){
            ...
            url = "http://172.16.61.0/webservices/anula.php";
